...
//validar_entrada("../../menu.php");
session_start();
$id = $_SESSION['id'];
//echo $id;
try {
    //El orden de las tablas al hacer un INNER JOIN, sí importa.
    //Primero, obtener los pedidos del cliente registrado.
    ...
    /**
     * Aqui solo esta obteniendo el primer valor del cliente obtenido (que es unico).
     * Deberia obtener el ultimo registro de ese pedido
     */
...
$pdf->Cell(52, 6, $bolsa[0]['created_at'], 1, 1, 'L');
$pdf->Multicell(0, 2, "");
