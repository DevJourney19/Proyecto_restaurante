                    ...
                    <form>
                        <div class="double_input">
                            <div>
                                ...
                                <input
                                    title="nombre completo para contacto"
                                    type="text"
                            ...
                            <div>
                                <label for="age"> Acompañantes* </label>
                                <input
                                    title="edad para permitir realizar el contacto"
                                    type="number"
                        ...
                        <div class="double_input">
                            ...
                            <div>
                                ...
                                <input
                                    title="numero de telefono para contacto"
                                    type="text"
                                    pattern="[0-9]{7,9}"
                                    placeholder="914703631"
                                    id="phone_number"
                                    required />
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="double_input">
                                <div>
                                    <input title="hora de la reserva" type="time" id="time" />
                                </div>
                                <div>
                                    <input
        ...
        <footer class="footer_reservation">
            <div class="footer_desc">
                <img
                    ...
                    alt="logo"
                    class="Logo de la Trattoria Secreta"
                    width="70"
                    heigth="70" />
                <p>
...
=======
  ...
  <body>
    ...
    <main>
      ...
      <div class="container_res">
        <section>
          <form method="POST" action="procesarReservacion.php">
            <div class="double_input">
              <div>
                <label for="full_name"> Nombre Completo </label>
                <input
...
>>>>>>> c36fb5331d3efda0af1cd4a85762b7732f0398cf
</html>
