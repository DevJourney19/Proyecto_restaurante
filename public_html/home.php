...
if (!isset($_SESSION['usuario'])) {
    ...
    //verificar si se encontro el nombre en la base de datos
    if ($row) {
        ...
        <header>
            <nav class="navbar navbar-expand-xl py-4 px-md-5 bg-black px-1">
                <div class="container-fluid">
                    ...
                    <h1 class="titulo"><span style="color: white; text-decoration: none">Bienvenido(a) <?php echo utf8_decode($nombre_completo); ?> 
                            a</span> <span style="text-decoration: underline #FFB100">La Trattoria Secreta</span></h1>
                    ...
                    <div class="nav_icons icons_xl">
                        <a href="menu.php"><i class="bx bx-cart"></i></a>
                        <a class="login" href="php/close_session.php"><i class='bx bx-exit'></i></a>
                        <a class="logout" href="index.php"><i class='bx bx-exit'></i></a>
                    </div>
                </div>
            </nav>
        </header>
